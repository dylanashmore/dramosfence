export const services = {
  wood: {
    ...
    intro:
      "Wood fencing is a timeless choice that blends naturally with any property, offering both privacy and a welcoming feel. Its adaptability makes it suitable for both residential and commercial settings, giving you the flexibility to design a fence that fits your exact needs. A wood fence also creates a natural sound barrier, reducing outside noise and enhancing comfort in outdoor spaces. Many homeowners choose wood because it provides an inviting backdrop that adds character and value to a property. A properly built wood fence provides both function and beauty that lasts for years.",
    bullets: [
  ...
  aluminum: {
    ...
    intro:
      "Aluminum fencing offers the perfect balance of strength and elegance. It is commonly chosen for its sleek appearance. At the same time, it provides reliable security without the need for heavy upkeep. Its adaptability makes it suitable for a wide range of property layouts, from residential yards to commercial spaces. Many property owners choose aluminum fencing to combine durability with an attractive design that endures.",
    bullets: [
